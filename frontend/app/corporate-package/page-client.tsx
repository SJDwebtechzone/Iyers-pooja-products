  ...
  <div className="relative z-10 w-full max-w-[1800px] mx-auto px-6 lg:px-10">
    <div className="max-w-[650px] lg:ml-[52%]">
      ...
      <section className="px-4 pb-20 pt-6 sm:px-8 max-w-[1400px] mx-auto">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#3B0E12] via-[#521319] to-[#3B0E12] p-6 text-white shadow-2xl sm:p-10 lg:p-12">
          <div className="pointer-events-none absolute -left-10 -top-10 h-48 w-48 rounded-full bg-[#E5C77A]/10 blur-2xl" />
          <div className="pointer-events-none absolute -bottom-10 -right-10 h-48 w-48 rounded-full bg-[#E5C77A]/10 blur-2xl" />

          <div className="relative z-10 flex flex-col items-center justify-between gap-6 md:flex-row sm:gap-8">
            <div className="flex items-center gap-5">
              {/*
              <div className="relative h-20 w-20 shrink-0 sm:h-28 sm:w-28">
                <Image
                  src="/images/cta_kalasam.png"
                  alt="Traditional kalasam for corporate pooja"
                  fill
                  sizes="112px"
              ...
              */}
              ...
              <div>
                <h3 className="font-[family-name:var(--font-cormorant)] text-xl font-semibold text-[#E5C77A] sm:text-2xl">
                  Planning an Auspicious Beginning?
                </h3>

                <h2 className="mt-1 font-[family-name:var(--font-cormorant)] text-2xl font-bold tracking-tight text-[#FFFDF8] sm:text-3xl lg:text-4xl">
                  Bring Divine Blessings to Your Workplace.
                </h2>

                <div className="mt-2.5 flex flex-wrap items-center gap-3 text-xs text-[#F3EAD8]/90 sm:gap-4">

        ...
        <div className="mt-8 rounded-2xl bg-white border border-[#DFCBB0] p-5 sm:p-8 shadow-[0_10px_35px_rgba(80,20,30,0.06)] overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <p className="mt-3 text-base leading-relaxed text-[#55463E] sm:text-lg">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                {selectedPooja.highlights.map((highlight, idx) => (
                  <div key={idx} className="flex items-start gap-2.5">
                    ...
                    <span className="text-base font-medium text-[#42151B] leading-snug sm:text-lg">
                      {highlight}
                    </span>
                  </div>
                ))}
            ...
            {bookingSuccess ? (
              <div className="py-8 text-center">
                ...
                <p className="text-sm text-[#55463E]">
                  Our team will contact you shortly to confirm your priest request.
                </p>
              </div>
            ) : (
              <>

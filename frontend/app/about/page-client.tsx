  ...
  <div className="relative z-10 mx-auto max-w-[1500px]">
    ...
    <div className="mt-16 sm:mt-20">
      ...
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border border-[#E2D2BA] bg-[#FFFDF9] px-7 py-9 sm:px-12 sm:py-12 text-center shadow-[0_18px_45px_rgba(90,24,32,0.06)]">
        ...
        <div className="pointer-events-none absolute inset-x-[8%] top-[22%] h-[56%] rounded-xl backdrop-blur-[3px]" />
        ...
        <blockquote className="relative z-10 translate-y-4 font-[family-name:var(--font-cormorant)] text-2xl sm:text-3xl lg:text-4xl font-semibold leading-snug text-white">

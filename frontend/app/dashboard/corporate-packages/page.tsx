...
const CATEGORIES = [
  ...
  { slug: "ayudha-pooja-vehicle-pooja", label: "Ayudha Pooja & Vehicle Pooja" },
  { slug: "aarthi-prasadam-distribution", label: "Aarthi & Prasadam Distribution" },
];
...
function PackageDetailsTable({
  ...
  async function loadItems() {
    ...
    setError(null);
    try {
      const res = await fetch(`${API_BASE}/corporate-packages/${category}`);

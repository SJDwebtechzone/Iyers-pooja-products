...
export default function TemplePackagePage() {
  ...
  // -----------------------------------------------------------
  // FETCH LIVE TEMPLE PACKAGE ITEMS
  // -----------------------------------------------------------
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="text-[#55463E] text-[15px] sm:text-base leading-relaxed mb-3">
              ...
              experienced priests using authentic Vedic procedures passed
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
                    ...
                    <div className="flex items-start sm:items-center gap-2 text-xs sm:text-[13px] text-[#6E584D] italic bg-[#F7EFE1] p-3 rounded-lg border border-[#E5D7C0] max-w-xl">
                      ...
                      <span>
                        The items & quantities may vary slightly based on the
              ...
              {activeTab === "process" && (
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6E584D] mt-1">
                      Traditional rituals performed with devotion and care.
                    </p>
                  </div>

                  <div className="space-y-4">

                    {poojaProcessSteps.map((process) => (
                      <div
                        key={process.step}
                        className="flex gap-4 p-4 sm:p-5 rounded-xl bg-white border border-[#DFCBB0] shadow-sm"
                      >

                        <div className="shrink-0 w-11 h-11 rounded-full bg-[#5A121D] text-[#E7BE6B] flex items-center justify-center font-semibold text-sm">
                          {process.step}
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#9E2A2B] mt-0.5 font-medium">
                            {process.titleTa}
                          </p>

                          <p className="text-sm text-[#5D4E47] leading-relaxed mt-2">
                            {process.desc}
                          </p>
                        </div>
              ...
              {activeTab === "benefits" && (
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6E584D] mt-1">
                      Spiritual benefits traditionally associated with the
                      sacred rituals.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {benefitsList.map((benefit) => {
                      ...
                      return (
                        <div
                          key={benefit.title}
                          className="p-5 rounded-xl bg-white border border-[#DFCBB0] shadow-sm"
                        >

                          <div className="w-11 h-11 rounded-full bg-[#5A121D] flex items-center justify-center mb-3">
                            <Icon
                              size={20}
                              className="text-[#E7BE6B]"
                            />
                          </div>
                          ...
                          <p className="text-xs text-[#9E2A2B] mt-1 font-medium">
                            {benefit.titleTa}
                          </p>
              ...
              {activeTab === "notes" && (
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6E584D] mt-1">
                      Please review these guidelines before booking your
                      temple ritual.
                    </p>
                  </div>
                    ...
                    {importantNotes.map((note, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="w-8 h-8 rounded-full bg-[#5A121D] text-[#E7BE6B] flex items-center justify-center shrink-0 text-sm font-semibold">
                            {index + 1}
                          </div>
                          ...
                          <div className="flex-1">
                            ...
                            <ul className="mt-2 space-y-2">
                              ...
                              {note.points.map((point) => (
                                <li
                                  key={point}
                                  className="flex items-start gap-2 text-sm text-[#5D4E47] leading-relaxed"
                                >
                                  <CheckCircle2
                                    size={15}
